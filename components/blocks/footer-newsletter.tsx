...
/** From 21st.dev (@hfroget) — 4-column footer with newsletter. */
export const Footer: FC<FooterProps> = ({
  ...
  return (
    <footer className={cn("border-t bg-muted/50 text-foreground", className)} {...props}>
      <div className="container mx-auto grid grid-cols-1 gap-8 px-4 py-16 md:grid-cols-2 lg:grid-cols-4 lg:gap-12">
        <div className="flex flex-col items-start gap-4">
          <div className="flex items-center gap-3">
            <img src={logoSrc} alt={`${companyName} Logo`} className="h-10 w-10" />
